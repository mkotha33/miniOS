...
public class CalendarProgram extends JFrame implements ItemListener
{
    JPanel p1, p2;
    JComboBox month;
    JComboBox year;
    ...
    public CalendarProgram(String title)
    {
        super();
        getContentPane().setFont(new Font("Stencil", Font.PLAIN, 11));
    ...
    {
        CalendarProgram frame = new CalendarProgram("Calendar");
    }
